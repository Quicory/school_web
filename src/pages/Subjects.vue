<template>
  <div class="q-pa-md">
    <div class="q-table__title q-ml-md">Asignaturas</div>
    <q-table
      flat
      bordered
      title="Asignaturas"
...
import { Subject, Paging } from 'src/interfaces';
...
const showDialog = (modo: string, data: Subject) => {
  $q.dialog({
