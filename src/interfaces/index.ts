export type { LoginResponse } from './auth/login-response';
export type { User } from './auth/user';
export type { Paging } from './paging';

export type { TeacherResponse } from './teacher/teacher-response';
export type { TeacherResponseOne } from './teacher/teacher-response-one';
export type { Teacher } from './teacher/teacher';
export type { TeacherNew } from './teacher/teacher-new';

export type { SubjectResponse } from './subject/subject-response';
